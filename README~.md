<h1 align="center">
    <br> 
    LoCode Nodes and improvements for ComfyUI
</h1>

<p align="center">
    <a href="#-nodes-table">Nodes</a> &nbsp; | &nbsp; <a href="#-side-bar">LoCode Side bar</a>
</p>
<hr>
...
# Nodes Table <a id="-nodes-table"></a>

| **Category** | **Node** | **Description** |
|-|-|-|
| ui | [`Comment`](#comment-lo) | Beautiful comments in your workflow. |
| ui | [`Docs`](#docs-lo) | Markdown documentation. |
| texts | [`Texts`](#texts-lo) | An array of texts presented as tabs. |
| texts | [`Replacers`](#replacers-lo) | Helps with text replacement. |
| texts | [`ReplacersApply`](#replacersapply-lo) | Applies replacers from `Replacers`. |
| texts | [`ReplaceVars`](#replacevars-lo) | Replaces parameters in a string enclosed in curly braces. |
| reroutes | [`ReRoutes`](#reroutes-lo) | Rerouting multiple parameters. |
| reroutes | [`Set`](#set-lo--get-lo) → [`Get`](#set-lo--get-lo) | A pair of nodes for setting/getting a list of parameters. |
| reroutes | [`SetProps`](#setprops-lo--getprops-lo) → [`GetProps`](#setprops-lo--getprops-lo) | A pair of nodes for passing arbitrary parameters through a single link. |
| params | [`SetVideoProps`](#-set-get-video-props) → [`GetVideoProps`](#-set-get-video-props) | A pair of nodes for setting video parameters and their compact transmission. |
| calc | [`Evals`](#evals-lo) | Evaluates a Python expression with variables. |
| calc | [`CompareNum`](#comparenum-lo) | Compares two numbers using a selected operation. |
| calc | [`RandomNum`](#randomnum-lo) | Generates random integer/float values in the range `[min, max)`. |
| calc | [`RandomBool`](#randombool-lo) | Generates a random boolean value with probability `true_weight`. |
| calc | [`IsEmpty`](#isempty-lo) | Checks a value for “empty”. |
| calc | [`IsNone`](#isnone-lo) | Checks the input value for `None` and passes through the original value. |
| convert | [`ToInt`](#toint-lo) | Converts any type to `INT` using a rounding method. |
| convert | [`ToFloat`](#tofloat-lo) | Converts any type to `FLOAT`. |
| convert | [`ToBool`](#tobool-lo) | Converts any type to `BOOLEAN`. |
| convert | [`ToStr`](#tostr-lo) | Converts any type to `STRING`. |
| lists | [`SetList`](#setlist-lo) | Converts any types into a list. |
| lists | [`ListLen`](#listlen-lo) | Counts items in a list. |
| lists | [`ListJoin`](#listjoin-lo) | Joins a list into a string. |
| lists | [`StrList`](#strlist-lo) | Converts a string into a list of strings. |
| lists | [`NumList`](#numlist-lo) | Converts a string of numbers into a list of integers and floats. |
| lists | [`FromList`](#fromlist-lo) | Returns a value from a list by index. |
| lists | [`ListsMerge`](#listsmerge-lo) | Merges lists and/or single values into one list. |
| utils | [`Log`](#log-lo) | Logs a value (optionally with sound and elapsed time). |
| utils | [`Beep`](#beep-lo) | Plays a sound and passes the value further. |
| utils | [`Switcher`](#switcher-lo) | Selects an input value by index (with modulo). |
| utils | [`Counter`](#counter-lo) | Two-position counter (major/minor). |
| system | [`MkDir`](#mkdir-lo) | Creates a directory if it doesn't exist. |
| system | [`ReadDir`](#readdir-lo) | Reads the contents of a directory. |
| system | [`RmDir`](#rmdir-lo) | Removes a directory and all its contents. |
| system | [`FileExists`](#fileexists-lo) | Checks if a file or directory exists. |
| system | [`CountDirImages`](#countdirimages-lo) | Counts images in a directory. |
